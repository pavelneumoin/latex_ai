...
const FEATURES: Record<string, string[]> = {
  free: [
    "Бесплатные уроки каждого курса (PDF и исходники)",
    "Кабинет: классы и списки учеников",
    "10 автопроверок работ в месяц",
    "Покупка любых материалов поштучно",
  ],
  math: [
    "Все PDF-материалы по математике",
    "Новые уроки — сразу в вашей библиотеке",
    "300 автопроверок в месяц",
    "LaTeX-отчёты по классам без ограничений",
  ],
  informatics: [
    "Все PDF-материалы по информатике",
    "Новые уроки — сразу в вашей библиотеке",
    "300 автопроверок в месяц",
    "LaTeX-отчёты по классам без ограничений",
  ],
  all: [
    "Математика + информатика: все PDF",
    "Исходники Marp и LaTeX всех материалов",
